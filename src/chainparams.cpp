 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1571411111, nBits=1e0ffff0, nNonce=684250, vtx=1)
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 99999999; 
     ...
     genesis = CreateGenesisBlock(1571411111, 392226, 0x1e0ffff0, 1, 50 * COIN);
      ...
      //  vSeeds.push_back(CDNSSeedData("walletbuilders.com", "node1.walletbuilders.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x00000b1cbac4fec906043321181e2d5ec49ac01e8872fa8a0e3c8f66742dc82c"))
        };

        chainTxData = ChainTxData{
            1571411111, // * UNIX timestamp of last known number of transactions

 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1571419306, nBits=1e0ffff0, nNonce=684250, vtx=1)
     ...
     genesis = CreateGenesisBlock(1571419306, 419276, 0x1e0ffff0, 1, 50 * COIN);
      ...
      //  vSeeds.push_back(CDNSSeedData("walletbuilders.com", "node1.walletbuilders.com"));
        ...
        chainTxData = ChainTxData{
            1571419306, // * UNIX timestamp of last known number of transactions
